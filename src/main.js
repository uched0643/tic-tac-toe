...
let winScore;
(_a = document
    .getElementById("restart")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => location.reload());
(_b = document
    .getElementById("ok-btn")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => location.reload());
(_c = document
    .getElementById("ok-btn-draw")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => location.reload());
(_d = document
    .getElementById("ok-btn-failed")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", () => location.reload());
let winArray = [
    [1, 2, 3],
    [4, 5, 6],
    [7, 8, 9],
    ...
    checkPlayerResult =
        userPosition.length == 0
            ...
            : userPosition[userPosition.length - 2] == undefined
                ? userPosition[userPosition.length - 1][randomNmberFunction(userPosition.length)][checkPlayerResult]
                : userPosition[userPosition.length - 2][0].filter((a) => a.includes(checkPlayerResult))[0];
